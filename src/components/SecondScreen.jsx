...
function SecondScreen() {
  ...
  return (
    <div className="secondscreen-container flex flex-col h-screen bg-black">
      ...
      <div className="flex h-[700px]">
        ...
        <div
          ...
          className="secondscreen-left w-1/2 flex items-center justify-center transform transition-transform duration-300 hover:scale-105 bg-black-gradient-to-r from-black to-[#111111] px-12"
        >
        ...
        <div
          className="secondscreen-right w-1/2 relative bg-cover bg-no-repeat bg-center"
          style={{
      ...
      <div
        className="secondscreen-bottom w-1/2 bg-cover bg-center bg-no-repeat flex items-center justify-center transform transition-transform duration-300 hover:scale-105"
        style={{
      ...
      >
        ...
        <button
          ...
          onClick={() => navigate('/game')} // Yönlendirme istediğin gibi
        >
          Oyuna Başla
        </button>
      </div>
